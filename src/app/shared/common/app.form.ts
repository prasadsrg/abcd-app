...
export class AppFormGroup {
    ...
    static NAME_PATTERN: string = "[a-zA-Z ]*$";
    ...
    static getController(require: boolean, type: String, minLength: number, maxLength: number) {
        ...
        if(type) {
            switch(type) {
                ...
                case AppFormGroup.APLPHA_NUMERIC :  compose.push(Validators.pattern(AppFormGroup.APLPHA_NUMERIC)); break;
                case AppFormGroup.PHONE_PATTERN :  compose.push(Validators.pattern(AppFormGroup.PHONE_PATTERN)); break;
                case AppFormGroup.LOCATION_PATTERN :  compose.push(Validators.pattern(AppFormGroup.LOCATION_PATTERN)); break;
                case AppFormGroup.NAME_PATTERN :  compose.push(Validators.pattern(AppFormGroup.NAME_PATTERN)); break;
